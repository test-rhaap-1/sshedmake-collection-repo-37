"""A hello-world filter plugin in sshedmake_namespace_37.myrhdh_37."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_37 Myrhdh_37
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_37.myrhdh_37.hello_world }}"
"""
